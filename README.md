...
+ The file [`DATASET_EIGENVALUES_KnownSpectra.csv`](DATASET_EIGENVALUES_KnownSpectra.csv/) contains lines of the form theta_0, theta_1, ... , theta_r,
+ The file [`DATASET_MULTIPLICITIES_KnownSpectra.csv`](DATASET_MULTIPLICITIES_KnownSpectra.csv/) contains lines of the form mult_0, mult_1, .... , mult_r,
